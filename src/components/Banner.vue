...
<template>
    <div class="banner" id="banner">
        <!-- 加载层 -->
        <div class="bg back"><h1>疯狂加载中...</h1></div>
        <!-- 脚贴 -->
        <div class="fork-me">
            <div class="fork-me-link">
                <span class="fork-me-text">个人主页</span>
            </div>
        </div>
        <!-- 背景层 -->
        ...
        <div data-aos="fade-in" class="desc">
            <span class="avatar ant-avatar ant-avatar-circle ant-avatar-image">
                <img draggable="false" src="../assets/wechat.jpg">
            </span>
            <div>
                <h1>{{banner.title}}</h1>
...
<style scoped lang="scss">
    ...
    .banner {
        ...
        .bg {
            ...
            height: 100%;
            z-index: -1;
            background: $--color-cyan url("../assets/bg.png") no-repeat center center scroll;
